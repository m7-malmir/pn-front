        ...
        <section class='TableSection'>
            <div style='overflow: auto;width: 100%;position: relative;'>
                <table style='width: 100%;max-width: 100%;background-color: inherit;'>
                            ...
                            <th class=''>
                                <div class='search_div' id=''>
                                    ...
                                    <select name='c3RhdHVz'>
                                        <option value='' class='select_option' selected>همه وضعیت</option>
                                        <option value='بررسی' class='select_option'>بررسی(9)</option>
                                        <option value='تخصیص' class='select_option'>تخصیص(0)</option>
                                        <option value='جایگزینی' class='select_option'>جایگزینی(2)</option>
                                        <option value='انصراف' class='select_option'>انصراف(0)</option>
                                        <option value='مردود' class='select_option'>مردود(0)</option>
                                        <option value='ویرایش' class='select_option'>ویرایش(8)</option>
                                        <option value='مردود انصراف' class='select_option'>مردود انصراف(0)</option>
                                        <option value='مردود ویرایش' class='select_option'>مردود ویرایش(0)</option>
                                        <option value='مردود جایگزینی' class='select_option'>مردود جایگزینی(0)</option>
                                        <option value='مردود تخصیص' class='select_option'>مردود تخصیص(0)</option>
                                        <option value='مردود بررسی' class='select_option'>مردود بررسی(1)</option>
                                    </select>
                                </div>
                            </th>
                            <th class=''>
                    ...
                    <tr style="">
                        <td style='width:35px;'>
                            <div class='Counter' style='color:#6600cc;'>6</div>
                        </td>
                        <td class='MiddleScreen' style='width:35px;'>
                            <div class='ImageField'>
                        ...
                        <td class='LittleScreen'><input value="1402-12-26 17:50"></input></td>
                        <td class='LittleScreen'><input value="امیر راشدی"></input></td>
                        <td style='width:60px;' class='LittleScreen'><input value='مردود بررسی'></input></td>
                        <td><input value='0946543976'></input></td>
                        <td><input value='علی &nbsp;قاسم زاده'></input></td>
                        <td class='MiddleScreen'><input value='خشکبار حمید'></input></td>
                        <td><input value='کدپستی نامعتبر'></input></td>
                        <td><input value=''></input></td>
                        <td><input value=''></input></td>
                        <td><input value=''></input></td>
                        <td style='position:sticky;left:0;background-color: inherit;'>
                            <div style='display:flex;flex-direction:row;width:60px;'>
                                <form action='view.php#7210' method='GET' style='display:flex;margin-block-end: 0;'>
                                    <button class='AcceptButton' name='aWRjb2Rl' value='0946543976'>
                                        نمایش
                                    </button>
                                    <input type='hidden' name='c2lk' value='7210'></input>
                                </form>
                            </div>
                        </td>
                    </tr>
