...
<main>
    <form action='' method='POST' style='display:flex;flex-direction:column;max-width:1024px;margin:50px auto;'
        ...
        <section class='InfomrationTable'>
            <article>
                ...
                <div style='display:flex;width:130px;'>
                    <button class='SendButton' type="submit" name='' value="3813"
            ...
            ?>
                    <div class='TablingInfo'>
                        <table>
                            <tr>
                                <th>تاریخ ثبت</th>
                                <td><input name='' value='<?= $value['date']; ?>'></input></td>
                            </tr>
                            <tr>
                                <th>جنسیت</th>
                                <td>
                            ...
                            <tr>
                                <th>نام</th>
                                <td><input name='customer_manager_name' value='<?= $value['customer_manager_name']; ?>'
                                        required></input></td>
                            ...
                            <input name='' value='2790249695' type='hidden'></input>
                            <tr>
                                <th>کشور</th>
                                <td>
                        ...
                        <table>
                            ...
                            <tr>
                                <th>نام خانوادگی</th>
                                <td><input name='customer_manager_family' value='<?= $value['customer_manager_family']; ?>'
                                        required></input></td>
                            </tr>
                            <tr>
                                <th>تاریخ تولد</th>
                            ...
                            <tr>
                                <th>ش. شناسنامه</th>
                                <td><input name='customer_certid' value='<?= $value['customer_certid']; ?>' required></input>
                                </td>
                            </tr>
                            <tr>
                                <th>کد پستی</th>
                                <td><input name='customer_postal_code' value='<?= $value['customer_postal_code']; ?>'
                                        maxlength='10'
                            ...
                            <tr>
                                ...
                                <td><input name='customer_cert_serial' value='<?= $value['customer_cert_serial']; ?>'></input>
                                </td>
                            </tr>
                            <tr>
                                <th>ردیف شناسنامه</th>
                ...
                <section class='InfomrationTable'>
                    <article>
                        ...
                        <div style='display:flex;width:130px;'>
                            <button class='SendButton' name='' value="3813"
                                style="background-image:url('<?= ROOT_URL; ?>public/assets/img/GreenCheck.webp')"></button>
                        </div>
                    </article>
                    <div class='TablingInfo'>
                        <table>
                            ...
                            <tr> 
                                <th>نشانی</th>
                                <td colspan='2'><input name='cus_repres1_address'
                                        value='<?= $value['cus_repres1_address']; ?>'></input></td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                            ...
                            <tr>
                                <th>فروشگاه</th>
                                <td><input name='cus_repres1_store_name'
                                        value='<?= $value['cus_repres1_store_name']; ?>'></input></td>
                            </tr>
                        </table>
                    </div>
                </section>
                <section class='InfomrationTable'>
                    ...
                    <div class='TablingInfo'>
                        <table>
                            ...
                            <tr>
                                <th>نشانی</th>
                                <td colspan='2'><input name='cus_repres2_address'
                                        value='<?= $value['cus_repres2_address']; ?>'></input></td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                            ...
                            <tr>
                                <th>فروشگاه</th>
                                <td><input name='cus_repres2_store_name'
                                        value='<?= $value['cus_repres1_store_name']; ?>'></input></td>
                            </tr>
                        </table>
                    </div>
                ...
                <section class='InfomrationTable'>
                    ...
                    <div class='TablingInfo'>
                        <table>
                            <tr>
                                <th>نام</th>
                                <td><input name='' value='undefined'></input></td>
                            </tr>
                            <tr>
                                <th>نام پدر</th>
                                <td><input name='' value='undefined'></input></td>
                            ...
                            <tr>
                                <th>تلفن ثابت</th>
                                <td><input name='' maxlength='11' value='undefined'
                                        oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);'></input>
                                </td>
                            </tr>
                            <tr>
                                <th>نشانی</th>
                                <td colspan='3'><input name='' value='undefined'></input></td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style='width:calc(100% - 100px);display:flex;'>
                                        <input name='customer_tel' style='width:calc(100% - 50px);'
                                            value='<?= $value['customer_tel']; ?>' maxlength='8'
                                            oninput='javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);'></input>
...
' readonly></input>
                            ...
                            <tr>
                                <th>نام فروشگاه</th>
                                <td><input name='customer_store_name' value='<?= $value['customer_store_name']; ?>' required></input>
                                </td>
                            </tr>
                            <tr>
                                <th>استان</th>
                                <td><input name='' value=''></input></td>
                            </tr>
                            <tr>
                                <th>نشانی</th>
                                <td colspan='2'><input name='customer_address' value='<?= $value['customer_address']; ?>'
                                        required></input></td>
                            </tr>
                        </table>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class='search_field'
                                        ...
                                        <input style='width:100%;' id="SearchFilter11" name=""
                                            placeholder="جستجو شهر" onkeyup="filterItems11(this);" autocomplete='off'
                                            value='<?= $value['customer_city']; ?>'>
                                        <select id="SelectFilter11" name="" size="4" onChange="update11();"
                                            style='width:100%;display:none;height:150px;position:absolute;top:36px;' required>
