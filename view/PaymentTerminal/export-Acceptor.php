...
?>
	<title>گزارش بر مبنای پذیرنده</title>
<?php 
...
<main>
	<section id='Charts'>
		...
		<script>
		var xValues = [14,15,16,17,18,19,20];
		var yValues = [2,2,5,3,1,1,1];
	...
	<section id='FunctionalMenu'>
				...
				<a href='Functionment/' class='classification'>
					<button style=''>
						<img src='/membership/bank/PaymentTerminal/V1/images/pos1.webp'></img>
					</button>
					<p>نمایش عملکرد پذیرنده</p>
				</a>
				<a href='Functionment/Export/' class='classification'>
					<button style=''>
						<img src='/membership/bank/PaymentTerminal/V1/images/pos1.webp'></img>
					</button>
					<p>اکسل عملکرد پذیرنده</p>
				</a>
			</div>
			<div>
				<a href='Functionment/Periodic/Monthly/' class='classification'>
					<button style=''>
						<img src='/membership/bank/PaymentTerminal/V1/images/pos1.webp'></img>
					</button>
					<p>عملکرد فرایندی ماهانه</p>
				</a>

				<a href='Output/Excel/' class='classification'>
					<button style=''>
						<img src='/membership/bank/PaymentTerminal/V1/images/pos1.webp'></img>
					</button>
					<p>خروجی اکسل پذیرنده</p>
				</a>
			</div>
			</section>
</main>
